...
from SwinTransformerV2_padding_mask_ape import SwinTransformerV2
...
f_train = open( "P_M_train_ape.log", mode="w", encoding = "UTF-8" )
f_train.close()
f_val = open( "P_M_val_ape.log", mode="w", encoding = "UTF-8" )
f_val.close()
...
for epoch in range(epoch_begin, config.num_epochs):
    ...
    if val_loss < val_loss_best:
        ...
        torch.save(
            ...
            'loss': loss,},
            f'model_SWTRFV2_padding_mask_ape.pth')
