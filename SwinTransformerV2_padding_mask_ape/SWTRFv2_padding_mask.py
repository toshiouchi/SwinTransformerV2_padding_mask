...
from SwinTransformerV2_padding_mask_no_downsample2 import SwinTransformerV2
...
PATH = 'model_SWTRFV2_padding_mask_no_rpb_best.pth'
...
f_train = open( "P_M_train.log", mode="w", encoding = "UTF-8" )
f_train.close()
f_val = open( "P_M_val.log", mode="w", encoding = "UTF-8" )
f_val.close()
...
for epoch in range(epoch_begin, config.num_epochs):
    ...
    if val_loss < val_loss_best:
        ...
        torch.save(
            ...
            'loss': loss,},
            f'model_SWTRFV2_padding_mask_no_rpb_best.pth')
...
torch.save(
    ...
    'optimizer_state_dict': optimizer.state_dict(),
    'loss': loss,},
    f'model_SWTRFV2_padding_mask_no_rpb.pth')
