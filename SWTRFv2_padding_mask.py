...
from SwinTransformerV2_padding_mask import SwinTransformerV2
...
PATH = 'model_SWTRFV2_padding_mask_best.pth'
...
for epoch in range(epoch_begin, config.num_epochs):
    ...
    if val_loss < val_loss_best:
        ...
        torch.save(
            ...
            'loss': loss,},
            f'model_SWTRFV2_padding_mask_best.pth')
...
torch.save(
    ...
    'optimizer_state_dict': optimizer.state_dict(),
    'loss': loss,},
    f'model_SWTRFV2_padding_mask.pth')
